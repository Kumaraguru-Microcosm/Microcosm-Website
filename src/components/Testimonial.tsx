                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testimonials.map((testimonial) => (
                        <div key={testimonial.id} className="bg-white rounded-lg shadow-lg p-6 transition-transform transform hover:scale-105">
                            ...
                            <p className="text-gray-600 mb-1">{testimonial.role} at <span className="text-blue-500">{testimonial.company}</span></p>
                            <p className="text-gray-700 mb-4">{testimonial.message}</p>
                            <div className="flex justify-center space-x-4">
                                <a href={testimonial.social.linkedin} className="text-blue-500 hover:text-blue-700">
                                ...
                                <a href={testimonial.social.twitter} className="text-blue-400 hover:text-blue-600">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
